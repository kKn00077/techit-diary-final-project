export default function Logo({ type = 1 }) {
	...
	const subTextClass = 'text-base font-gowun-dodum text-Black-black-1100'
	...
	const content = {
		0: (
			<div class={`${containerClass}`}>
				<div class={`text-4xl text-center ${baseClass}`}>today I Feel</div>
			</div>
		),
		1: (
			<div class={`${containerClass}`}>
		...
		2: (
			<div class="flex flex-col content-center text-Purple-purple-500">
				<div class="text-lg font-gowun-batang font-bold">today</div>
				<div class="text-2xl font-gowun-batang font-bold">I Feel</div>
			</div>
		),
		default: (
			<div class={`${containerClass}`}>
				<div class="flex flex-row gap-2 items-end leading-none text-Purple-purple-500 font-gowun-batang font-bold">
					...
					<span class="text-lg">I Feel</span>
				</div>
